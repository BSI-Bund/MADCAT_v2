...
#ifndef UDP_IP_PORT_MON_WORKER_H
#define UDP_IP_PORT_MON_WORKER_H

#include "udp_ip_port_mon.h"

/**
  * \brief Handels incoming UDP Datagramms
  *
  *     Handels UDP Datagramms, proxying and matching of related UDP datagrams to UDP "Connections"
  *
  * \param buffer Pointer to the raw packet data
  * \param recv_len length of raw packet data
  * \param hostaddress local address to filter for
