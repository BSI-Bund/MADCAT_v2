...
struct proxy_conf_udp_t *pc; //globally defined to be easly accesible inside rsp-proxy to check if root priviliges can be dropped (ports <1023)
struct udpcon_data_t *uc;
