...
--TCPv4 configuration
hostaddress = "192.168.1.100" --address to listen on
--TCPv6 configuration
...
--             [222]   = { "192.168.1.200", 22 },
           }

--UDP Proxy configuration
udpproxy_tobackend_addr = "192.168.1.200" --Local address to communicate to backends with. Mandatory, if "udpproxy" is configured.
